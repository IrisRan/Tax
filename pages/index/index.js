  ...
  getInput: function (e) {
    ...
    if (!e.detail.value) {
      for (temp = 0; temp < this.data.taxArray.length; temp++) {
        if (this.data.taxArray[temp].parentIndex == parentIndex && this.data.taxArray[temp].childIndex == childIndex) { /*删除原来的输入*/
      ...
      this.data.taxArray.push({ parentIndex, childIndex, equivalent, emission })
    } 
